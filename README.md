...
**A lightweight wedding planning control board that keep vendors, guests, budget, tasks, and planning notes in one place.**
...
## Why I Built It
Most wedding planning problems aren't caused by bad decisions.

They're caused by information being spread across:
...
The goal of this tracker is simple:

keep the current planning state visible in one place.
...
I build lightweight trackers for situations where there are too many moving parts to keep in your head.

Most projects don't need another platform.

They need a simple place where decisions, tasks, and information stay connected.

Wedding planning happens to be one example.
## Limitations
